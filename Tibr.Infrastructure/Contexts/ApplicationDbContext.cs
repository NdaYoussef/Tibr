    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<KYCDocument>()
                .HasOne(k => k.User).WithMany(u => u.KYCDocuments)
                .HasForeignKey(k => k.UserId).OnDelete(DeleteBehavior.Cascade);

            modelBuilder.Entity<KYCDocument>()
                .HasOne(k => k.ReviewedByAdmin).WithMany(a => a.ReviewedDocuments)
                .HasForeignKey(k => k.ReviewedBy).OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity<Support>()
                .HasOne(st => st.User).WithMany(u => u.SupportTickets)
                .HasForeignKey(st => st.UserId).OnDelete(DeleteBehavior.Cascade);

            modelBuilder.Entity<Ticket>()
                .HasOne(tr => tr.Support).WithMany(st => st.Tickets)
                .HasForeignKey(tr => tr.SupportId).OnDelete(DeleteBehavior.Cascade);

            modelBuilder.Entity<Ticket>()
                .HasOne(tr => tr.Admin).WithMany(a => a.TicketReplies)
                .HasForeignKey(tr => tr.AdminId).OnDelete(DeleteBehavior.Cascade);

            modelBuilder.Entity<AuditLog>()
                .HasOne(al => al.Admin).WithMany(a => a.AuditLogs)
                .HasForeignKey(al => al.AdminId).OnDelete(DeleteBehavior.Cascade);
