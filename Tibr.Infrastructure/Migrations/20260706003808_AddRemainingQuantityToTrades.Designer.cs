...
namespace Tibr.Infrastructure.Migrations
{
    ...
    [Migration("20260706003808_AddRemainingQuantityToTrades")]
    partial class AddRemainingQuantityToTrades
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tibr.Domain.Entities.ChatConversation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Tibr.Domain.Entities.ChatMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Tibr.Domain.Entities.ChatOrderProposal", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Tibr.Domain.Entities.OrdersInvestment", b =>
                {
                    ...
                    b.Property<decimal?>("MaxBudgetEgp")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Tibr.Domain.Entities.Plan", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<DateTime?>("LastReevaluatedAt")
                        .HasColumnType("datetime2");

                    b.Property<decimal?>("MonthlyBudgetEgp")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal?>("SilverPriceAtCreation")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Tibr.Domain.Entities.PriceSnapshot", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("AssetType", "SnapshotDate")
                        .IsUnique();
            ...
            modelBuilder.Entity("Tibr.Domain.Entities.Review", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Tibr.Domain.Entities.Withdraw", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Tibr.Domain.Entities.ChatMessage", b =>
                {
                    b.HasOne("Tibr.Domain.Entities.ChatConversation", "Conversation")
                        .WithMany("Messages")
